...
export function HierarchicalTermSelector({
  ...
  return createElement(Flex, {
    direction: "column",
    gap: "4"
  }, showFilter && createElement(TextControl, {
    __nextHasNoMarginBottom: true,
    label: filterLabel,
    value: filterValue,
    onChange: setFilter
  ...
  }, renderTerms('' !== filterValue ? filteredTermsTree : availableTermsTree)), !loading && hasCreateAction && createElement(FlexItem, null, createElement(Button, {
