...
export default function PostLockedModal() {
  ...
  return createElement(Modal, {
    ...
    width: 64,
    height: 64
  }), createElement("div", null, !!isTakeover && createElement("p", null, createInterpolateElement(userDisplayName ? sprintf( /* translators: %s: user's display name */
  ...
  })), !isTakeover && createElement(Fragment, null, createElement("p", null, createInterpolateElement(userDisplayName ? sprintf( /* translators: %s: user's display name */
  ...
  })), createElement("p", null, __('If you take over, the other user will lose editing control to the post, but their changes will be saved.'))), createElement(HStack, {
    className: "editor-post-locked-modal__buttons",
    justify: "flex-end"
  }, !isTakeover && createElement(Button, {
    variant: "tertiary",
    href: unlockUrl
  }, __('Take over')), createElement(Button, {
    variant: "primary",
    href: allPostsUrl
  }, allPostsLabel)))));
}
