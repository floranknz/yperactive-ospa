...
function HierarchicalTermSelector({
  ...
  const renderTerms = renderedTerms => {
    return renderedTerms.map(term => {
      ...
      }), !!term.children.length && (0, _react.createElement)("div", {
  ...
  return (0, _react.createElement)(_components.Flex, {
    direction: "column",
    gap: "4"
  }, showFilter && (0, _react.createElement)(_components.TextControl, {
    __nextHasNoMarginBottom: true,
    label: filterLabel,
    value: filterValue,
    onChange: setFilter
  ...
  }, renderTerms('' !== filterValue ? filteredTermsTree : availableTermsTree)), !loading && hasCreateAction && (0, _react.createElement)(_components.FlexItem, null, (0, _react.createElement)(_components.Button, {
    onClick: onToggleForm,
    className: "editor-post-taxonomies__hierarchical-terms-add",
    "aria-expanded": showForm,
    variant: "link"
  }, newTermButtonLabel)), showForm && (0, _react.createElement)("form", {
    onSubmit: onAddTerm
    ...
    required: true
  }), !!availableTerms.length && (0, _react.createElement)(_components.TreeSelect, {
    __next40pxDefaultSize: true,
    __nextHasNoMarginBottom: true,
