...
var _exportNames = {
  ...
  __experimentalFullscreenModeClose: true,
  __experimentalMainDashboardButton: true,
  store: true
};
...
function initializeEditor(id, postType, postId, settings, initialEdits) {
  ...
  if (isMediumOrBigger && (0, _data.select)(_preferences.store).get('core', 'showListViewByDefault') && !(0, _data.select)(_preferences.store).get('core', 'distractionFree')) {
  ...
  root.render((0, _react.createElement)(_editor2.default, {
    settings: settings,
    postId: postId,
    postType: postType,
...
function reinitializeEditor() {
  (0, _deprecated.default)('wp.editPost.reinitializeEditor', {
    since: '6.2',
    version: '6.3'
  });
}
