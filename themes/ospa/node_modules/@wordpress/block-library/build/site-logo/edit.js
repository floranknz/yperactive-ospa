...
const SiteLogo = ({
  ...
  const classes = (0, _clsx.default)('custom-logo-link');
  const {
    imageEditing,
    maxWidth,
    title
  ...
  const img = (0, _react.createElement)(_react.Fragment, null, (0, _react.createElement)("img", {
  ...
  }), (0, _blob.isBlobURL)(logoUrl) && (0, _react.createElement)(_components.Spinner, null));
  let imgWrapper = img;
...
function LogoEdit({
  ...
  const controls = canUserEdit && logoUrl && !temporaryURL && (0, _react.createElement)(_blockEditor.BlockControls, {
    group: "other"
  ...
  if (!!logoUrl || !!temporaryURL) {
    logoImage = (0, _react.createElement)(_react.Fragment, null, (0, _react.createElement)(SiteLogo, {
      alt: alt,
  ...
  return (0, _react.createElement)("div", {
    ...blockProps
  }, controls, mediaInspectorPanel, (!!logoUrl || !!temporaryURL) && logoImage, !temporaryURL && !logoUrl && !canUserEdit && (0, _react.createElement)(_components.Placeholder, {
    className: "site-logo_placeholder"
  }, !!isLoading && (0, _react.createElement)("span", {
    className: "components-placeholder__preview"
  }, (0, _react.createElement)(_components.Spinner, null))), !temporaryURL && !logoUrl && canUserEdit && (0, _react.createElement)(_blockEditor.MediaPlaceholder, {
    onSelect: onInitialSelectLogo,
    accept: ACCEPT_MEDIA_STRING,
    allowedTypes: ALLOWED_MEDIA_TYPES,
    onError: onUploadError,
