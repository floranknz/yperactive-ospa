...
export default function TemplatePartEdit({
  ...
  const {
    ...
    const _canEditTemplate = (_select$canUser = select(coreStore).canUser('create', 'templates')) !== null && _select$canUser !== void 0 ? _select$canUser : false;
    return {
  ...
  }, isEntityAvailable && onNavigateToEntityRecord && canEditTemplate && createElement(BlockControls, {
    group: "other"
  ...
  }, __('Edit'))), createElement(InspectorControls, {
    group: "advanced"
  ...
  }), createElement(InspectorControls, null, createElement(TemplatesList, {
    area: area,
    clientId: clientId,
    isEntityAvailable: isEntityAvailable,
