...
export default function Image({
  ...
  const controls = createElement(Fragment, null, createElement(BlockControls, {
    group: "block"
  }, isSingleSelected && !isEditingImage && !lockHrefControls && !lockUrlControls && createElement(ImageURLInputUI, {
    url: href || '',
    ...
    icon: crop,
    label: __('Crop')
  }), isSingleSelected && canInsertCover && createElement(ToolbarButton, {
    icon: overlayText,
    label: __('Add text over image'),
    onClick: switchToCover
  })), isSingleSelected && !isEditingImage && !lockUrlControls && createElement(BlockControls, {
    group: "other"
  ...
  })), isSingleSelected && externalBlob && createElement(BlockControls, null, createElement(ToolbarGroup, null, createElement(ToolbarButton, {
  ...
  createElement(BlockControls, {
    ...
    }, _x('Alt', 'Alternative text for an image. Block toolbar label, a low character count is preferred.')),
    renderContent: () => createElement(TextareaControl, {
    ...
    renderContent: () => createElement(TextControl, {
      className: "wp-block-image__toolbar_content_textarea",
      __nextHasNoMarginBottom: true,
    ...
    resetAll: resetAll,
    dropdownMenuProps: TOOLSPANEL_DROPDOWNMENU_PROPS
  }, isSingleSelected && createElement(ToolsPanelItem, {
    label: __('Alternative text'),
  ...
  if (canEditImage && isEditingImage) {
    img = createElement(ImageWrapper, {
      href: href
  ...
  return createElement(Fragment, null, controls, img, createElement(Caption, {
