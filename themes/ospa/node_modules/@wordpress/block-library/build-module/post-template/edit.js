...
export default function PostTemplateEdit({
  ...
  return createElement(Fragment, null, createElement(BlockControls, null, createElement(ToolbarGroup, {
    ...
    ...blockProps
  }, blockContexts && blockContexts.map(blockContext => createElement(BlockContextProvider, {
    key: blockContext.postId,
    value: blockContext
  }, blockContext.postId === (activeBlockContextId || blockContexts[0]?.postId) ? createElement(PostTemplateInnerBlocks, {
    classList: blockContext.classList
  }) : null, createElement(MemoizedPostTemplateBlockPreview, {
    blocks: blocks,
