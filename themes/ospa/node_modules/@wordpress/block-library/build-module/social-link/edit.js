...
const SocialLinkEdit = ({
  ...
  return createElement(Fragment, null, createElement(InspectorControls, null, createElement(PanelBody, {
    ...
    __nextHasNoMarginBottom: true,
    label: __('Link text'),
    help: __('The link text is visible when enabled from the parent Social Icons block.'),
    value: label,
  ...
  }, socialLinkText)), isSelected && showURLPopover && createElement(SocialLinkURLPopover, {
    url: url,
