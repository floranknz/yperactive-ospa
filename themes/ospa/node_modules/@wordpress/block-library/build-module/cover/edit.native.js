...
const Cover = ({
  ...
  const placeholderIcon = createElement(Icon, {
    icon: icon,
  ...
  const bottomLabelText = customOverlayColor ? createElement(Text, {
    style: selectedColorText
  }, customOverlayColor.toUpperCase()) : __('Select a color');
  const colorPickerControls = createElement(InspectorControls, null, createElement(BottomSheetConsumer, null, ({
  ...
  const renderBackground = getMediaOptions => createElement(TouchableWithoutFeedback, {
