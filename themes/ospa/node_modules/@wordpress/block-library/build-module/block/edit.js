...
import { useInnerBlocksProps, RecursionProvider, useHasRecursion, useBlockProps, Warning, privateApis as blockEditorPrivateApis, store as blockEditorStore, BlockControls } from '@wordpress/block-editor';
...
export default function ReusableBlockEditRecursionWrapper(props) {
  ...
  if (hasAlreadyRendered) {
    return createElement(RecursionWarning, null);
  }
  return createElement(RecursionProvider, {
    uniqueId: ref
  }, createElement(ReusableBlockEdit, {
    ...props
  }));
}
function ReusableBlockEdit({
  ...
  return createElement(Fragment, null, userCanEdit && onNavigateToEntityRecord && createElement(BlockControls, null, createElement(ToolbarGroup, null, createElement(ToolbarButton, {
    onClick: handleEditOriginal
  }, __('Edit original')))), canOverrideBlocks && createElement(BlockControls, null, createElement(ToolbarGroup, null, createElement(ToolbarButton, {
